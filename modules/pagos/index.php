...
<html>
    <head>
      <meta charset="utf-8">
      <title>Pagos</title>
      <meta name="description" content="Pagos de Alumnos"/>
      ...
      <script src="controllers/usuarios.js?n=7"></script>
  ...
  <div id="loading_dog" class="loading col-md-12 text-center" style="display:none; opacity: 0.9; border-radius: 10px; z-index: 99; position:fixed; width:100%;height:100px; top:0px;" ><img style="width: 100px; height: 400px;" src="assets/img/anydog2.gif" alt="Cargando..."  ></div>
    <div class="container-fluid">
          ...
          <div class="col-md-12 col-xs-12" >
              <form class="form-inline alert alert-default" name="form_search"  id="form_search" role="form">
                  <div class="input-group">
                   <span id="dog_count" class="input-group-addon"  for="id_moodle">IDMoodle:</span >
                  ...
                  <div class="input-group">
                   <span  class="input-group-addon"  for="numero_referencia">Referencia Bancaria:</span >
                    <input type="text" name="numero_referencia" size="10" id="numero_referencia" class="form-control input-form_search" value="">
                  </div>
                  <div class="input-group">
        ...
        <div id="view_usuarios" class="row" >
          ...
          <div class="col-md-10 col-md-offset-1 col-xs-12  panel panel-default" >
              <div class="panel-body">
                <!--<div class="row">
                    <div class="col-md-12">
                      <a href="https://agcollege.edu.mx/registro_manual_pago/" target="_black" class="btn btn-success" >Pagos por Excel <i class="glyphicon glyphicon-upload"></i></a>                    
                    </div>
                </div>-->
                <div class="row" style="margin-top:10px;" >
                  <div class="col-md-12">
                      <div class="list-group" style=" height:350px; overflow-y: auto; ">
                        ...
                        <div  class="list-group-item" style="background-color: #27ae60; color: white;" >
                         Resultados de Alumnos <span class="pull-right fui-list-large-thumbnails" ></span>
                          ...
                          <tbody id="content_usuarios"> <!--Content usuarios-->
                            <tr class="text-center" >
                                <td colspan="8"  >Por favor ingresa tu busqueda de alumno</td>
                            </tr>
        ...
        <div id="view_pagos_usuarios"  style="display:none;" class="row" >

          <div class="col-md-10 col-md-offset-1 col-xs-12  panel panel-default" >
              <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                      <button class="btn btn-default" type="button" id="btn_back" > < Regresar</button>
                    </div>
                </div> 
                <div class="row" style="margin-top:10px;" >
                  <div class="col-md-12">
                      <div class="list-group" style=" height:350px; overflow-y: auto; ">
                        ...
                        <div  class="list-group-item" style="background-color: #1abc9c; color: white;" >
                        Pagos Realizados por el Alumno <span class="pull-right fui-list-large-thumbnails" ></span>
                        </div>
                          <table class="table" >
                          <thead>
                            <tr>
                                ...
                                <th>Monto</th>
                                <th>Fecha de Pago</th>
                                <th>Fecha de Periodo Pagado</th>
                                <th>Registro</th>
                            </tr>
                          </thead>
                          <tbody id="content_pagos"> <!--Content pagos-->
                            <tr class="text-center" >
                                <td colspan="8"  >...</td>
                            </tr>
                          </tbody><!-- CONTENT pagos -->
                      ...
                      <table class="table table-user-information">
                       <form class="form"  id="form_usuario_update" name="form_usuario_update"  >
                        <tbody>
                          ...
                          <td>Región:</td>
                            <td>
                                <select type="number"  tabindex="10" name="id_region" id="f_u_id_region" error="Selecciona la region." class="form-input input-form_usuario_update" > 
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"  >
                <form class="form form-inline" id="form_pago" name="form_pago" >
                  ...
                  -->
                  <div class="input-group">
                   <span id="dog_count" class="input-group-addon"  for="id_servicio">Concepto</span >
                    <select type="number" tabindex="1" id="form_pago_nomenclatura" name="id_servicio" class="input-form_pago form-control"   error="selecciona el concepto del pago" required style="width: 150px;"  required>
                  ...
                  <div class="input-group">
                   <span id="dog_count" class="input-group-addon"  for="fecha_pago">Fecha de pago</span >
                     <input type="text" tabindex="2"  id="form_fecha_pago" placeholder="DD-MM-AAAA" name="fecha_pago" class="input-form_pago form-control" error="Ingesa la fecha correctamente" required style="width: 110px;" required>
                  </div>
                    <div class="input-group">
                   <span id="dog_count" class="input-group-addon"  for="fecha_pago_periodo">Fecha de Periodo Pagado</span >
                     <input type="text" tabindex="3" maxlength="10" id="form_fecha_pago_periodo" placeholder="DD-MM-AAAA" name="fecha_periodo" class="input-form_pago form-control" error="Ingesa la fecha del periodo pagado por el alumno correctamente" required style="width: 115px;" required>
                  </div>
                   <div class="input-group">
                   <span id="dog_count" class="input-group-addon"  for="monto">Monto $</span >
                     <input type="number"  tabindex="4" maxlength="10"  id="form_pago_monto" placeholder="100.00" name="monto" class="input-form_pago form-control" error="Ingesa el monto del pago" required style="width: 115px;" required>
                  </div>
                    <div class="input-group">
                      <span id="dog_count" class="input-group-addon"  for="reactivar">¿Reactivar Alumno?</span >
                     <input type="checkbox" tabindex="5" id="form_pago_reactivar" class="input-form_pago form-control" name="reactivar" value="reactivar" style="width: 50px;"  >
                   </div>
                  ...
                  <form id="form_reactivar" name="form_reactivar" > 
                     <input type="hidden" name="id_alumno" id="form_reactivar_id_alumno" class="input-form_reactivar  form-control" value="0"> 
                    <input type="hidden" name="id_persona" id="form_reactivar_id_persona" class="input-form_reactivar  form-control" value="0"> 
                    <input type="hidden" name="id_moodle" id="form_reactivar_id_moodle" class="input-form_reactivar form-control" value="0"> 
                    <input type="hidden" name="id_plan_estudio" id="form_reactivar_id_plan_estudio" class="input-form_reactivar form-control" value="0"> 
                   </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="pull-left btn btn-default" data-dismiss="modal">Cancelar</button>
             <button type="button" id="btn_reactivar" tabindex="7" class="pull-left btn btn-primary" >Solo Reactivar Alunno</button>
             <button type="button" id="btn_suspender" tabindex="8" class="pull-left btn btn-warning" >Suspender Alumno</button>

             <button type="button" id="btn_insert_pago" tabindex="6" class="pull-right btn btn-success" >Registrar Pago</button>
          </div>
        </div>

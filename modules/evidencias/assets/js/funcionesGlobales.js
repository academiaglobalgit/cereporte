...
function openNewWindowPost(winURL, params)
{
	/*if(!viewInTab){
		viewInTab = 'target';		
	}*/
	...
	var new_tab = window.open(winURL, winName);
	//form.target = winName;
	form.submit();                 
...
function isNull(tipo, value)
{
    switch(tipo.toUpperCase())
    {
        ...
        case "CALLBACK": return typeof value == undefined || value == 'undefined' || value == null;
        default: return true;
    }	        
}
...
//METODO QUE VALIDA EL FORMATO DE UN EMAIL

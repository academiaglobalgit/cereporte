...
<html>
  ...
  <body>
    ...
    ?>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          ...
          <div class="row col-md-12" ><h2>Incidencias Globales</h2></div>
          <div class="row">
          ...
          <div class="row col-md-12" ><h2>Mis Incidencias</h2></div>
          ...
          <div class="row col-md-12" ><h2>Incidencias Solucionadas por <?php echo $nombre_completo ?></h2></div>
          ...
          <div class="row">
              ...
              <div class="col-md-3">
                <div class="panel panel-success">
                  <div class="panel-heading text-center">
                    <h1 id="i_solucionadas">...</h1>
                  </div>
                  <div class="panel-body small text-muted">
                  <span class="glyphicon glyphicon-ok" ></span> Solucionadas
                  </div>
                </div>
              </div>
          </div>
    ...
    <script src="controllers/index.js?n=1"></script>

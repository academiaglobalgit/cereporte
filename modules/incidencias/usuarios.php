      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          <div class="row"><!--TITULO DE MODULO-->
            <div class="col-md-12">
              <p><h1>Catalogo de usuarios DE JIMMY</h1></p>
              <ol class="breadcrumb">
              ...
              <div class="row">
                <form id="form_u_crear" name="form_u_crear" >
                       <div class="form-group" >
                         Corporacion:
                              <select type="number" id="form_u_crear_corporacion" name="id_corporacion" class="input-form_u_crear form-control" error="Selecciona una corporacion." required>
                                <option value="" selected>selecciona una Corporación</option>
                                <option value="1" >AgCollege</option>
                                <option value="2" >Coppel</option>
                                <option value="3" >Soriana</option>
                                <option value="4" >Casa Ley</option>
                                <option value="6" >Universidad México Internacional</option>
                                <option value="7" >Toks</option>
                                <option value="8" >Mabe</option>
                              </select>
                      </div>
                      <div class="form-group" >
                          Nombre:
                ...
                <form id="form_u_editar" name="form_u_editar" >
                      ...
                      <div class="form-group" >
                        <input type="hidden" id="form_u_editar_id_usuario" value="" name="id_usuario" class="input-form_u_editar form-control" error="Selecciona correctamente el usuario." required>
                         <input type="hidden" id="form_u_editar_id_persona" value="" name="id_persona" class="input-form_u_editar form-control" error="Selecciona correctamente el usuario." required>
                          Nombre:

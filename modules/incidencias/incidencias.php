...
<html>
  ...
  <body>
	  ...
	  <div id="page-content-wrapper">
		...
		<div class="page-content inset">
			<div class="row"><!--TITULO DE MODULO-->
				<div class="col-md-12">
					<p><h1>Listado de Incidencias</h1></p>
					<ol class="breadcrumb">
			...
			<div class="row"><!--BOTON CREAR-->
			  ...
			  <div class="col-md-12">
				  ...
				  <div class="panel-heading">
					 <h3 class="panel-title"><span class=" glyphicon glyphicon-list"></span> Listado de Incidencias 
					 <!-- <button class="btn btn-default btn_menu_filtros"  type="button" >Filtros Avanzados<span class=" glyphicon glyphicon-filter"></span></button> --> 
					 </h3>
					...
					<div class="row"><!--BOTON FILTROS-->
						<div class="col-md-12">
							<form id="form_i_search" class="form-inline" name="form_i_search" >
								<div class="row">
									<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
										<div class="input-group" >
											<span class="input-group-addon" id="basic-addon1"># ID Incidencia</span>
									...
									<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
										<div class="input-group" >
											...
											<input type="text" id="form_i_search_numero_empleado" value="" name="form_i_search_numero_empleado" class="input-form_i_search form-control" error="Ingrese un número empleado" placeholder="900124" >
										</div>
									</div>
									<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
										<div class="input-group" >
											<span class="input-group-addon" id="basic-addon1">Plataforma</span>
											<select type="text" id="form_i_search_plataforma" name="form_i_search_plataforma" class="input-form_i_search form-control" error="Selecciona una plataforma" placeholder="plataforma" >
											</select>
										</div>
									</div>
									<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
									...
									<div  id="div_i_search_area" class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
										<div class="input-group">
									...
									<div class='col-xs-3 col-sm-3 col-md-3 col-lg-3' style='padding:5px;'>
										<div class="input-group" >
											...
											<select type="number" id="form_i_search_estatus" name="form_i_search_estatus" class="input-form_i_search form-control" error="Selecciona una estatus" placeholder="estado" >
											</select>
										</div>
									</div>
								...
								<input type="hidden" id="form_i_search_id_usuario_registra" value="" name="form_i_search_id_usuario_registra" class="input-form_i_search form-control" error="Ingrese un número de persona del usuario"  >
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					  <div class="row">
						...
						<div class="form-group">
							<form id="form_i_crear_interna" name="form_i_crear_interna" >
								...
								<div class="form-group">
									Plataforma:
									<select type="number" id="form_i_crear_id_plan_estudios_interna" name="form_i_crear_id_plan_estudios" class="input-form_i_crear form-control" error="Selecciona una opción" placeholder="Selecciona el plan estudios del problema" required>
									</select>
									<small>NOTA: Si la incidencia no hace referencia a algúna plataforma, elige <strong>Plan No Definido<strong>.</small>

								</div>
								<div class="form-group">
									# Empleado del Alumno de la incidencia (OPCIONAL): 
									<input type="text" id="form_i_crear_numero_empleado_interna" name="form_i_crear_numero_empleado" class="input-form_i_crear form-control" error="ingresa el Número de empleado del alumno" placeholder="#empleado o Estafeta">
									<small>NOTA: Si la incidencia no hace referencia a algún alumno, no necesitas poner el #Empleado.</small>
								</div>
								...
								<div class="form-group" >
									Comentarios:
									<textarea type="text" id="form_i_crear_comentarios_interna" name="form_i_crear_comentarios" class="input-form_i_crear form-control" error="Ingrese un comentario" placeholder="Ingrese un comentario descriptivo de la problematica" required></textarea> 
								</div>
								<!-- <div class="form-group">
									Correo electrónico:
					  ...
					  <div class="row">
						...
						<div class="form-group">
							<form id="form_i_editar_interna" name="form_i_editar_interna" style="display: none;">
								...
								<div class="form-group">
									Plan de estudios del alumno:
									<select type="number" id="form_i_editar_id_plan_estudios_interna" name="form_i_editar_id_plan_estudios" class="input-form_i_editar_interna form-control" error="Selecciona una opción" placeholder="Selecciona el plan de estudios del alumno" required>
									</select>
								</div>
								...
								<div class="form-group">
									#Numero Empleado:
									<input type="text" id="form_i_editar_numero_empleado_interna" name="form_i_editar_numero_empleado" class="input-form_i_editar_interna form-control" error="Numero de empleado del alumno" placeholder="Num de empleado" >
								</div>
								<!--<div class="form-group">
									Usuario que Reporta:
								...
								<div class="form-group">
									Usuario que Soluciona:
									<input type="text" id="form_i_editar_nombre_soluciona_interna" name="form_i_editar_nombre_soluciona_interna" class="input-form_i_editar_interna form-control" error="Nombre del alumno" placeholder="no disponible" readonly>
								</div>
								...
								<div class="form-group" style="display:none;" >
									Problematica:
									<select type="number" id="form_i_editar_problematica_interna" name="form_i_editar_problematica" class="input-form_i_editar_interna form-control" error="Selecciona una problematica" placeholder="Problematica" readonly="readonly" required>
									</select>
								</div>
								<div class="form-group" >
									Comentarios:
									<textarea type="text" id="form_i_editar_comentarios_interna" name="form_i_editar_comentarios" class="input-form_i_editar_interna form-control" error="Ingrese un comentario" placeholder="Ingrese un comentario descriptivo de la problematica" required></textarea> 
								</div>
								<!--<div class="form-group">
									Correo electrónico:
				  ...
				  <div class="modal-body">
					...
					<form id="form_i_cancelar" name="form_i_cancelar" >
							<input type="hidden" id="form_i_cancelar_id_incidencia" name="id_incidencia" value="0" class="input-form_i_cancelar form-control" required>
	  						...
	  						<textarea type="text" id="form_i_cancelar_comentarios" name="comentarios" class="input-form_i_cancelar form-control" error="Ingrese un comentario." placeholder="Ingrese un comentario dirigido al usuario" ></textarea> 
					</form>
				  </div>
				  <div class="modal-footer">
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body">
						<form id="form_i_terminar"  name="form_i_terminar" >
							...
							Comentario:
							<textarea type="text" id="form_i_terminar_comentarios" name="comentarios" class="input-form_i_terminar form-control" error="Ingrese un comentario." placeholder="Ingrese un comentario dirigido al usuario" ></textarea> 
						</div>
					  	</form>
				  </div>
				  <div class="modal-footer">
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body">
						<form id="form_i_proceso"  name="form_i_proceso" >
							...
							Comentario:
							<textarea type="text" id="form_i_proceso_comentarios" name="comentarios" class="input-form_i_proceso form-control" error="Ingrese un comentario." placeholder="Ingrese un comentario dirigido al usuario" ></textarea> 
						</div>
					  	</form>
				  </div>
				  <div class="modal-footer">
    ...
    ?>
    	...
    	<script src="controllers/incidencias.js?n=1"></script>

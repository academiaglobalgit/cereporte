$( document ).ready(function() {
 	var online=false; //TRUE= online false= local
		...
		if(posts_.length==0 || posts_==null || posts_===undefined){
				...
				for (var i = 0; i < posts_.length; i++) {
					...
					if(i==0 && !alreadyPosted){ // primer post y no a posteado todavia
						...
						if(threads[idx_current_thread]['tipo'] == 1 || alreadyPosted){ // solo si ya posteo puede ver las respuestas de los demas alumnos

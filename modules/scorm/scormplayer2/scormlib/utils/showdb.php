...
$output .= "\t<td valign=top align=left><b>Scoid</b></td>\n";
...
$output .= "</tr>\n";
$result = mysql_query("select scormid,userid,element,value,scoid from tb_scorms_tracks where scormid='".$SCOInstanceID."' and userid='".$userid1."' order by scormid,element",$link);
while (list($SCOInstanceID,$userid,$varName,$varValue,$scoid) = mysql_fetch_row($result)) {
	...
	$output .= "\t<td valign=top align=center>$scoid</td>\n";

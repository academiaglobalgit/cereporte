...
@$fecha=date("d_m_Y");
$filename="Reporte_ayuda_alumnos_totales_plan_estudio.xls";
    ...
    if (isset($_GET)){
        ...
        $bd="escolar";
		 ...
		 $query_a2 = "call escolar.sp_reporte_ayudaalumnos_totales_plan_estudio();";
			...
			if($result_avance=$mysql->Query($query_a2)){
				...
				$reporte=ResultToArray($result_avance,true);
					...
					$table="<table border='1'>"; 
						...
						<thead>
						<tr>
							<th colspan='7' bgcolor='#D2D7D3' style='color:#22313F;'> <h3> REPORTE AYUDA TOTALES POR PLAN DE ESTUDIO </h3> </th>
						</tr>
						<tr>

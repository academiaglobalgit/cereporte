<?php
	...
	array_push($columns_tmp,new Column(3,1,"firstname","firstname","IFNULL((select tp.nombre 
				...
				inner join escolar.tb_alumnos ta on tp.id = ta.id_persona and  ta.id_plan_estudio = 1		
	...
	array_push($columns_tmp,new Column(44,1,"sexo","Sexo","IF((select escolar.tb_personas.sexo from escolar.tb_personas 
		...
		where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=1 limit 1),'')", "mdl_user","Responsable Inscripcion") );	

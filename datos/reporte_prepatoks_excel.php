...
AND
(ta.id_corporacion='7'  and ta.id_plan_estudio='9' ) and (select mdl_user_info_data.data from mdl_user_info_data where mdl_user_info_data.fieldid = '1' and mdl_user_info_data.userid = mdl_user.id limit 1) = 'Alumno' ORDER BY mdl_user.id ASC                   

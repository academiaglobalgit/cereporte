<?php
		...
		$id_plan_estudio_columnas = 47;

	array_push($columns_tmp,new Column(3,1,"ingreso","ingreso","IFNULL((select ta.fecha_inscripcion 
		from escolar.tb_alumnos ta where ta.idmoodle=mdl_user.id AND ta.id_plan_estudio=47 limit 1),' ')", "mdl_user","Fecha Inscripcion") );
	...
	array_push($columns_tmp,new Column(130,1,"responsable_admision","responsable_admision","IFNULL((select IF(escolar.tb_alumnos.id_usuario_responsable = 210, 'NO DEFINIDO', concat(usu.nombre,' ', ifnull(usu.apellidop,''),' ', ifnull(usu.apellidom,''))) from escolar.tb_alumnos LEFT JOIN escolar.tb_usuarios usu ON usu.id = escolar.tb_alumnos.id_usuario_responsable
				where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1),'')", "mdl_user","Responsable Admisión Inscripción") );	
				...
				WHERE escolar.tb_alumnos.idmoodle = mdl_user.id  AND escolar.tb_alumnos.id_plan_estudio = 47 LIMIT 1),'NO DEFINIDO')", "mdl_user","Responsable Gestión Escolar Inscripción") );
...
where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1),1)
...
inner join escolar.tb_alumnos on escolar.tb_personas.id=escolar.tb_alumnos.id_persona 
inner join escolar.tb_alumnos_estados on escolar.tb_alumnos_estados.id=escolar.tb_alumnos.estado
where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1),' ')", "mdl_user","Descripcion status") );
...
where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1),' ')", "mdl_user","Motivo Baja") );


array_push($columns_tmp,new Column(44,1,"sexo","Sexo","IF((select escolar.tb_personas.sexo from escolar.tb_personas 
inner join escolar.tb_alumnos on escolar.tb_personas.id=escolar.tb_alumnos.id_persona 
where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1)=1,'Masculino','Femenino')
", "mdl_user","Sexo",true) );
...
inner join escolar.tb_alumnos on escolar.tb_personas.id=escolar.tb_alumnos.id_persona and  escolar.tb_alumnos.id_plan_estudio = 47
inner join escolar.tb_alumnos_estados_log on escolar.tb_alumnos_estados_log.id_alumno=escolar.tb_alumnos.id
where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_corporacion=2 order by escolar.tb_alumnos_estados_log.fecha DESC limit 1),' ')", "mdl_user","Fecha status") );
	...
	*/
		...
		//columna tipo 1
	array_push($columns_tmp,new Column(6,1,"n_empleado","n_empleado","IFNULL((select escolar.tb_alumnos.numero_empleado from escolar.tb_alumnos
	where escolar.tb_alumnos.idmoodle=mdl_user.id AND escolar.tb_alumnos.id_plan_estudio=47 limit 1),' ')", "mdl_user","#Empleado",true) );	
...
/*
	...
	array_push($columns_tmp,new Column(88,1,"matricula","matricula_dgb","(
		SELECT tdb.matricula FROM escolar.tb_alumnos ta inner join escolar.tb_dgb_alumnos tdb on tdb.id_alumno=ta.id WHERE ta.idmoodle=mdl_user.id AND ta.id_plan_estudio=47 limit 1
...
*/
	...
	//	$columna= new Column(13,2,"data","materias_coppel","SELECT mc.IdMoodle as id,mc.Nombre as fullname ,mc.Periodo as periodo  FROM materias_cobaes mc  order by mc.Periodo ASC,mc.IdMatricula ASC", "mdl_user","Materias Cobaes");
		...
		array_push($columns_tmp,new Column(15,1,"numero_telefonico","numero_telefonico","IFNULL((SELECT tnt.numero_telefonico FROM escolar.tb_numeros_telefonicos tnt inner join escolar.tb_alumnos ta on tnt.id_alumno=ta.id WHERE  tnt.eliminado=0 and ta.idmoodle=mdl_user.id and ta.id_plan_estudio=47  order by tnt.id DESC limit 1),'SIN NUMERO')", "mdl_user","Numero Telefonico") );
		...
		$querisillo = "
			...
			FROM
				escolar.tb_alumnos
				INNER JOIN escolar.tb_personas ON tb_personas.id = tb_alumnos.id_persona AND tb_alumnos.id_plan_estudio = 47
		...
		$querisillo = "
			...
			WHERE
				...
				AND escolar.tb_alumnos.id_plan_estudio = 47
		...
		array_push($columns_tmp,new Column(998,1,"periodo_inscripcion","periodo_inscripcion","IFNULL((select periodo_inscripcion from escolar.tb_alumnos where id_plan_estudio = 47 and tb_alumnos.idmoodle =  mdl_user.id LIMIT 1) ,' ')", "mdl_user","Periodo Inscripcion"));
		...
		$query = "
			...
			FROM
				escolar.tb_alumnos a
				INNER JOIN escolar.tb_peticiones b ON b.id_alumno = a.id AND a.id_plan_estudio = 47
			WHERE
				a.idmoodle = mdl_user.id
			ORDER BY 
		...
		array_push($columns_tmp, new Column(
			...
			"promedio_general", 
			"promedio_general", 
			"IFNULL((SELECT COALESCE(FORMAT((SUM(IF(f.calificacion > 10, (f.calificacion * 0.1), f.calificacion))/COUNT(id)), 2), 0) FROM nprepacoppel.ag_calificaciones f WHERE f.id_alumno = mdl_user.id) ,' ')", 
			"mdl_user",
			"Promedio General")
		);
		...
		array_push($columns_tmp, new Column(
			...
			"periodo_actual", 
			"periodo_actual", 
			"COALESCE((SELECT MAX(j.periodo) FROM nprepacoppel.mdl_user_enrolments g INNER JOIN nprepacoppel.mdl_enrol h ON h.id = g.enrolid INNER JOIN escolar.tb_materias_ids i ON i.id_moodle = h.courseid AND i.id_plan_estudio = 47 INNER JOIN escolar.tb_materias j ON j.id = i.id_materia WHERE g.userid = mdl_user.id), 0)", 
			"mdl_user", 
			"Periodo Actual")
		);
	...
	$contador_row = 120;
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_2_MATEMÁTICAS_I",
				"P1_CAL_2_MATEMÁTICAS_I",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 2 LIMIT 1)",
				"mdl_user",
				"P1_CAL_2_MATEMÁTICAS_I")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_3_QUÍMICA_I_Y_II",
				"P1_CAL_3_QUÍMICA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 3 LIMIT 1)",
				"mdl_user",
				"P1_CAL_3_QUÍMICA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_4_ÉTICA_I_Y_II",
				"P1_CAL_4_ÉTICA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 4 LIMIT 1)",
				"mdl_user",
				"P1_CAL_4_ÉTICA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_5_METODOLOGÍA_DE_LA_INVESTIGACIÓN",
				"P1_CAL_5_METODOLOGÍA_DE_LA_INVESTIGACIÓN",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 5 LIMIT 1)",
				"mdl_user",
				"P1_CAL_5_METODOLOGÍA_DE_LA_INVESTIGACIÓN")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_6_TALLER_DE_LECTURA_Y_REDACCIÓN_I",
				"P1_CAL_6_TALLER_DE_LECTURA_Y_REDACCIÓN_I",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 6 LIMIT 1)",
				"mdl_user",
				"P1_CAL_6_TALLER_DE_LECTURA_Y_REDACCIÓN_I")
			);
		...
		array_push($columns_tmp, new Column(
				...
				"P1_CAL_50_INGLÉS_I",
				"P1_CAL_50_INGLÉS_I",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 50 LIMIT 1)",
				"mdl_user",
				"P1_CAL_50_INGLÉS_I")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P1_CAL_52_INFORMÁTICA_I",
				"P1_CAL_52_INFORMÁTICA_I",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 52 LIMIT 1)",
				"mdl_user",
				"P1_CAL_52_INFORMÁTICA_I")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P2_CAL_7_MATEMÁTICAS_II",
				"P2_CAL_7_MATEMÁTICAS_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 7 LIMIT 1)",
				"mdl_user",
				"P2_CAL_7_MATEMÁTICAS_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P2_CAL_8_BIOLOGÍA_I_Y_II",
				"P2_CAL_8_BIOLOGÍA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 8 LIMIT 1)",
				"mdl_user",
				"P2_CAL_8_BIOLOGÍA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P2_CAL_9_INTRODUCCIÓN_A_LAS_CIENCIAS_SOCIALES",
				"P2_CAL_9_INTRODUCCIÓN_A_LAS_CIENCIAS_SOCIALES",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 9 LIMIT 1)",
				"mdl_user",
				"P2_CAL_9_INTRODUCCIÓN_A_LAS_CIENCIAS_SOCIALES")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P2_CAL_10_TALLER_DE_LECTURA_Y_REDACCIÓN_II",
				"P2_CAL_10_TALLER_DE_LECTURA_Y_REDACCIÓN_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 10 LIMIT 1)",
				"mdl_user",
				"P2_CAL_10_TALLER_DE_LECTURA_Y_REDACCIÓN_II")
			);
		...
		array_push($columns_tmp, new Column(
				...
				"P2_CAL_11_INGLÉS_II",
				"P2_CAL_11_INGLÉS_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 11 LIMIT 1)",
				"mdl_user",
				"P2_CAL_11_INGLÉS_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P2_CAL_53_INFORMÁTICA_II",
				"P2_CAL_53_INFORMÁTICA_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 53 LIMIT 1)",
				"mdl_user",
				"P2_CAL_53_INFORMÁTICA_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_13_MATEMÁTICAS_III",
				"P3_CAL_13_MATEMÁTICAS_III",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 13 LIMIT 1)",
				"mdl_user",
				"P3_CAL_13_MATEMÁTICAS_III")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_14_FÍSICA_I_Y_II",
				"P3_CAL_14_FÍSICA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 14 LIMIT 1)",
				"mdl_user",
				"P3_CAL_14_FÍSICA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_15_HISTORIA_DE_MÉXICO_I_Y_II",
				"P3_CAL_15_HISTORIA_DE_MÉXICO_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 15 LIMIT 1)",
				"mdl_user",
				"P3_CAL_15_HISTORIA_DE_MÉXICO_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_16_LITERATURA_I_Y_II",
				"P3_CAL_16_LITERATURA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 16 LIMIT 1)",
				"mdl_user",
				"P3_CAL_16_LITERATURA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_17_INGLÉS_III",
				"P3_CAL_17_INGLÉS_III",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 17 LIMIT 1)",
				"mdl_user",
				"P3_CAL_17_INGLÉS_III")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P3_CAL_54_FORMACIÓN_PARA_EL_TRABAJO_I._CULTURA_EMPRENDEDORA",
				"P3_CAL_54_FORMACIÓN_PARA_EL_TRABAJO_I._CULTURA_EMPRENDEDORA",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 54 LIMIT 1)",
				"mdl_user",
				"P3_CAL_54_FORMACIÓN_PARA_EL_TRABAJO_I._CULTURA_EMPRENDEDORA")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P4_CAL_19_MATEMÁTICAS_IV",
				"P4_CAL_19_MATEMÁTICAS_IV",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 19 LIMIT 1)",
				"mdl_user",
				"P4_CAL_19_MATEMÁTICAS_IV")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P4_CAL_20_ESTRUCTURA_SOCIOECONÓMICA_DE_MÉXICO",
				"P4_CAL_20_ESTRUCTURA_SOCIOECONÓMICA_DE_MÉXICO",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 20 LIMIT 1)",
				"mdl_user",
				"P4_CAL_20_ESTRUCTURA_SOCIOECONÓMICA_DE_MÉXICO")
			);
		...
		array_push($columns_tmp, new Column(
				...
				"P4_CAL_21_INGLÉS_IV",
				"P4_CAL_21_INGLÉS_IV",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 21 LIMIT 1)",
				"mdl_user",
				"P4_CAL_21_INGLÉS_IV")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P4_CAL_55_FORMACIÓN_PARA_EL_TRABAJO_II._LEGALIDAD_EMPRESARIAL_Y_MERCADOTECNIA",
				"P4_CAL_55_FORMACIÓN_PARA_EL_TRABAJO_II._LEGALIDAD_EMPRESARIAL_Y_MERCADOTECNIA",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 55 LIMIT 1)",
				"mdl_user",
				"P4_CAL_55_FORMACIÓN_PARA_EL_TRABAJO_II._LEGALIDAD_EMPRESARIAL_Y_MERCADOTECNIA")
			);
		...
		array_push($columns_tmp, new Column(
				...
				"P5_CAL_24_GEOGRAFÍA",
				"P5_CAL_24_GEOGRAFÍA",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 24 LIMIT 1)",
				"mdl_user",
				"P5_CAL_24_GEOGRAFÍA")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P5_CAL_25_ADMINISTRACIÓN_I_Y_II",
				"P5_CAL_25_ADMINISTRACIÓN_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 25 LIMIT 1)",
				"mdl_user",
				"P5_CAL_25_ADMINISTRACIÓN_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P5_CAL_26_ECONOMÍA_I_Y_II",
				"P5_CAL_26_ECONOMÍA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 26 LIMIT 1)",
				"mdl_user",
				"P5_CAL_26_ECONOMÍA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P5_CAL_28_DERECHO_I_Y_II",
				"P5_CAL_28_DERECHO_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 28 LIMIT 1)",
				"mdl_user",
				"P5_CAL_28_DERECHO_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P5_CAL_31_PSICOLOGÍA_I_Y_II",
				"P5_CAL_31_PSICOLOGÍA_I_Y_II",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 31 LIMIT 1)",
				"mdl_user",
				"P5_CAL_31_PSICOLOGÍA_I_Y_II")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P5_CAL_56_FORMACIÓN_PARA_EL_TRABAJO_III._GESTIÓN_FINANCIERA_Y_VENTAS",
				"P5_CAL_56_FORMACIÓN_PARA_EL_TRABAJO_III._GESTIÓN_FINANCIERA_Y_VENTAS",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 56 LIMIT 1)",
				"mdl_user",
				"P5_CAL_56_FORMACIÓN_PARA_EL_TRABAJO_III._GESTIÓN_FINANCIERA_Y_VENTAS")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P6_CAL_27_HISTORIA_UNIVERSAL_CONTEMPORÁNEA",
				"P6_CAL_27_HISTORIA_UNIVERSAL_CONTEMPORÁNEA",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 27 LIMIT 1)",
				"mdl_user",
				"P6_CAL_27_HISTORIA_UNIVERSAL_CONTEMPORÁNEA")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P6_CAL_29_ECOLOGÍA_Y_MEDIO_AMBIENTE",
				"P6_CAL_29_ECOLOGÍA_Y_MEDIO_AMBIENTE",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 29 LIMIT 1)",
				"mdl_user",
				"P6_CAL_29_ECOLOGÍA_Y_MEDIO_AMBIENTE")
			);
		...
		array_push($columns_tmp, new Column(
				...
				"P6_CAL_30_FILOSOFÍA",
				"P6_CAL_30_FILOSOFÍA",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 30 LIMIT 1)",
				"mdl_user",
				"P6_CAL_30_FILOSOFÍA")
			);
		...
		array_push($columns_tmp, new Column(
				$contador_row++,
				1,
				"P6_CAL_57_FORMACIÓN_PARA_EL_TRABAJO_IV._COMUNICACIÓN_DE_LA_EMPRESA_Y_PROYECTO_EMPRENDEDOR.",
				"P6_CAL_57_FORMACIÓN_PARA_EL_TRABAJO_IV._COMUNICACIÓN_DE_LA_EMPRESA_Y_PROYECTO_EMPRENDEDOR.",
				"(SELECT a.calificacion FROM ag_calificaciones a WHERE a.id_alumno = mdl_user.id AND a.id_materia = 57 LIMIT 1)",
				"mdl_user",
				"P6_CAL_57_FORMACIÓN_PARA_EL_TRABAJO_IV._COMUNICACIÓN_DE_LA_EMPRESA_Y_PROYECTO_EMPRENDEDOR.")
			);

  ...
  REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(tp.apellido2),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U') as apellido2,
   REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(tp.nombre),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U') as nombre,
          ...
          $alumnos[$idx_alumno]['ultimo_acceso']=$row_alumno['ultimo_acceso'];
            ...
            (select tmi_ley.id_moodle from tb_materias_ids tmi_ley inner join tb_materias_relacion mr_ley on mr_ley.id_materia=tmi_ley.id_materia where tmi_ley.id_plan_estudio=13 and mr_ley.id_materia_autoridad=md.id limit 1 ) as idmoodle_sumate,
            (select tmi_ley.id_moodle from tb_materias_ids tmi_ley inner join tb_materias_relacion mr_ley on mr_ley.id_materia=tmi_ley.id_materia where tmi_ley.id_plan_estudio=17 and mr_ley.id_materia_autoridad=md.id limit 1 ) as idmoodle_agsocial,
            (select tmi_ley.id_moodle from tb_materias_ids tmi_ley inner join tb_materias_relacion mr_ley on mr_ley.id_materia=tmi_ley.id_materia where tmi_ley.id_plan_estudio=9 and mr_ley.id_materia_autoridad=md.id limit 1 ) as idmoodle_toks

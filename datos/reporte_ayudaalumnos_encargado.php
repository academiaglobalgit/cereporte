...
@$fecha=date("d_m_Y");
$filename="Reporte_ayuda_alumnos_encargado.xls";
    ...
    if (isset($_GET)){
        ...
        $bd="escolar";
		 ...
		 $query_a2 = "call escolar.sp_listado_ayuda_ticket(NULL, NULL, NULL, " . $_SESSION['id_area']  . 
		 ", 0, 0, 4);";
			...
			if($result_avance=$mysql->Query($query_a2)){
				...
				$reporte=ResultToArray($result_avance,true);
					...
					$table="<table border='1'>"; 
						...
						<thead>
						<tr>
							<th colspan='8' bgcolor='#D2D7D3' style='color:#22313F;'> <h3> REPORTE AYUDA ENCARGADO </h3> </th>
						</tr>
						<tr>
